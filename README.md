...
🚀 基于 Java 实现二十三种设计模式，浅显易懂，全部代码均在本地运行通过，并附上完整教程。

<img src="https://gitee.com/veal98/images/raw/master/img/20201224153700.png" style="zoom: 80%;" />

- `creational-pattern`：创建型模式的示例代码
- `structural-pattern`：结构型模式的示例代码
- `behavioral-pattern`：行为型模式的示例代码

✍ 目前尚在更新中 ..........

💌 欢迎各位小伙伴提 issue/PR 指正错误
...
| 序号 |                             图稿                             |                             模式                             | 🏆 重要性 |
| :--: | :----------------------------------------------------------: | :----------------------------------------------------------: | :------: |
|      |                                                              | [简单工厂模式 (Simple Factory) / 静态工厂方法模式 (Static Factory Method)](https://veal98.gitee.io/cs-wiki/#/计算机基础/设计模式/二十三种设计模式/创建型模式/0-简单工厂模式.md) |    4     |
|  1   | <img src="https://gitee.com/veal98/images/raw/master/img/20201206212655.png" alt="img" style="zoom:80%;" /> | [工厂方法模式 (Factory Method) / 工厂模式 (Factory)](https://veal98.gitee.io/cs-wiki/#/计算机基础/设计模式/二十三种设计模式/创建型模式/1-工厂方法模式.md) |    5     |
|  2   | <img src="https://gitee.com/veal98/images/raw/master/img/20201206212930.png" alt="img" style="zoom:80%;" /> | [抽象工厂模式 (Abstract Factory)](https://veal98.gitee.io/cs-wiki/#/计算机基础/设计模式/二十三种设计模式/创建型模式/2-抽象工厂模式.md) |    5     |
|  3   | <img src="https://gitee.com/veal98/images/raw/master/img/20201206212713.png" alt="img" style="zoom:80%;" /> | [建造者模式 / 生成器模式 (Builder)](https://veal98.gitee.io/cs-wiki/#/计算机基础/设计模式/二十三种设计模式/创建型模式/3-建造者模式.md) |    2     |
|  4   | <img src="https://gitee.com/veal98/images/raw/master/img/20201206212723.png" alt="img" style="zoom:80%;" /> | [原型模式 (Prototype)](https://veal98.gitee.io/cs-wiki/#/计算机基础/设计模式/二十三种设计模式/创建型模式/4-原型模式.md) |    1     |
|  5   | <img src="https://gitee.com/veal98/images/raw/master/img/20201206212734.png" alt="img" style="zoom:80%;" /> | [单例模式 (Singleton)](https://veal98.gitee.io/cs-wiki/#/计算机基础/设计模式/二十三种设计模式/创建型模式/5-单例模式.md) |    4     |
